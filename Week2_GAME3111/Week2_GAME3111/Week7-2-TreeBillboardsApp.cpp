...
void TreeBillboardsApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&boxRitem->World, XMMatrixScaling(2.0f, 0.1f, 2.0f) * XMMatrixTranslation(3.0f, 2.0f, -4.0f));
	...
	XMStoreFloat4x4(&cylinderRitem->World, XMMatrixScaling(3.0f, 3.0f, 3.0f) * XMMatrixTranslation(-3.0f, 6.2f, -10.8f));
	...
	XMStoreFloat4x4(&cylinderRitem1->World, XMMatrixScaling(3.0f, 3.0f, 3.0f) * XMMatrixTranslation(-3.0f, 6.2f, 3.0f));
	cylinderRitem1->ObjCBIndex = 3;
	...
	XMStoreFloat4x4(&cylinderRitem2->World, XMMatrixScaling(3.0f, 3.0f, 3.0f) * XMMatrixTranslation(9.0f, 6.2f, 3.0f));
	...
	XMStoreFloat4x4(&cylinderRitem3->World, XMMatrixScaling(3.0f, 3.0f, 3.0f) * XMMatrixTranslation(9.0f, 6.2f, -10.8f));
	cylinderRitem3->ObjCBIndex = 5;
	...
	XMStoreFloat4x4(&boxRitem1->World, XMMatrixScaling(0.1f, 0.4f, 2.0f) * XMMatrixTranslation(-3.0f, 4.0f, -4.0f));
	boxRitem1->ObjCBIndex = 6;
	...
	XMStoreFloat4x4(&boxRitem2->World, XMMatrixScaling(0.1f, 0.4f, 2.0f) * XMMatrixTranslation(9.0f, 4.0f, -4.0f));
	boxRitem2->ObjCBIndex = 7;
	...
	XMStoreFloat4x4(&boxRitem3->World, XMMatrixScaling(1.5f, 0.4f, 0.1f) * XMMatrixTranslation(2.5f, 4.0f, -11.0f));
	boxRitem3->ObjCBIndex = 8;
	...
	XMStoreFloat4x4(&boxRitem4->World, XMMatrixScaling(1.5f, 0.4f, 0.1f) * XMMatrixTranslation(2.5f, 4.0f, 3.0f));
	boxRitem4->ObjCBIndex = 9;
	boxRitem4->Mat = mMaterials["wirefence"].get();
	...
	XMStoreFloat4x4(&boxRitem5->World, XMMatrixScaling(8.5f, 0.9f, 0.5f)* XMMatrixTranslation(2.5f, 4.0f, -30.0f));
	boxRitem5->ObjCBIndex = 10;
	boxRitem5->Mat = mMaterials["wirefence"].get();
	...
	XMStoreFloat4x4(&boxRitem6->World, XMMatrixScaling(0.5f, 0.9f, 8.0f)* XMMatrixTranslation(20.5f, 4.0f, 2.0f));
	boxRitem6->ObjCBIndex = 12;
	boxRitem6->Mat = mMaterials["wirefence"].get();
	...
	XMStoreFloat4x4(&boxRitem7->World, XMMatrixScaling(0.5f, 0.9f, 7.5f)* XMMatrixTranslation(-30.5f, 4.0f, 2.0f));
	boxRitem7->ObjCBIndex = 13;
	boxRitem7->Mat = mMaterials["wirefence"].get();
	...
	XMStoreFloat4x4(&boxRitem8->World, XMMatrixScaling(2.0f, 0.9f, 0.5f)* XMMatrixTranslation(-5.5f, 4.0f, 20.0f));
	boxRitem8->ObjCBIndex = 14;
	boxRitem8->Mat = mMaterials["wirefence"].get();
	...
	XMStoreFloat4x4(&boxRitem9->World, XMMatrixScaling(0.5f, 0.9f, 4.5f)* XMMatrixTranslation(-15.5f, 4.0f, 2.0f));
	boxRitem9->ObjCBIndex = 15;
	boxRitem9->Mat = mMaterials["wirefence"].get();
	...
	XMStoreFloat4x4(&boxRitem10->World, XMMatrixScaling(0.5f, 0.9f, 8.0f)* XMMatrixTranslation(35.5f, 4.0f, 2.0f));
	boxRitem10->ObjCBIndex = 16;
	boxRitem10->Mat = mMaterials["wirefence"].get();
	boxRitem10->Geo = mGeometries["boxGeo"].get();
	...
	XMStoreFloat4x4(&boxRitem11->World, XMMatrixScaling(0.5f, 0.9f, 2.5f)* XMMatrixTranslation(3.5f, 4.0f, 27.8f));
	boxRitem11->ObjCBIndex = 17;
	boxRitem11->Mat = mMaterials["wirefence"].get();
	boxRitem11->Geo = mGeometries["boxGeo"].get();
	...
	mRitemLayer[(int)RenderLayer::Opaque].push_back(boxRitem11.get());
	mAllRitems.push_back(std::move(boxRitem11));

	auto boxRitem12 = std::make_unique<RenderItem>();
	XMStoreFloat4x4(&boxRitem12->World, XMMatrixScaling(3.0f, 0.9f, 0.5f)* XMMatrixTranslation(-5.5f, 4.0f, 40.0f));
	boxRitem12->ObjCBIndex = 18;
	boxRitem12->Mat = mMaterials["wirefence"].get();
	boxRitem12->Geo = mGeometries["boxGeo"].get();
	...
	auto boxRitem13 = std::make_unique<RenderItem>();
	XMStoreFloat4x4(&boxRitem13->World, XMMatrixScaling(3.5f, 0.9f, 0.5f)* XMMatrixTranslation(4.5f, 4.0f, -20.0f));
	boxRitem13->ObjCBIndex = 19;
	boxRitem13->Mat = mMaterials["wirefence"].get();
	boxRitem13->Geo = mGeometries["boxGeo"].get();
	boxRitem13->PrimitiveType = D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
	boxRitem13->IndexCount = boxRitem13->Geo->DrawArgs["box"].IndexCount;
	boxRitem13->StartIndexLocation = boxRitem13->Geo->DrawArgs["box"].StartIndexLocation;
	boxRitem13->BaseVertexLocation = boxRitem13->Geo->DrawArgs["box"].BaseVertexLocation;

	mRitemLayer[(int)RenderLayer::Opaque].push_back(boxRitem13.get());
	mAllRitems.push_back(std::move(boxRitem13));
